...
export default function Notify() {
      ...
      label: (
        <div className="notify__item">
          <div className="notify__item--icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-arrow-left-square" viewBox="0 0 16 16">
          ...
          <div className="notify__item--content flex items-center">
            <div onClick={() => {router.push('/dashboard');}} className="notify__item--title">Về Trang Khách Hàng</div>
    ...
    },
    {
      label: (
        <div className="notify__item">
          ...
          <div className="notify__item--content flex items-center">
            <div onClick={() => { signout();  }} className="notify__item--title">Đăng xuất</div>
  ...
  return (
    <>
      ...
      >
        <Button className="mt-5" type="text" icon={<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-gear" viewBox="0 0 16 16">
