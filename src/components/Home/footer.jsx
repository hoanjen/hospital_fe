        ...
        <div>
          <div className="flex flex-row">
                ...
                <div className="flex flex-row pb-2">
                  <div>
                    <svg
                      ...
                      height="25"
                      fill="currentColor"
                      className="pr-2 bi bi-house-door"
                      viewBox="0 0 16 16"
                    >
                  ...
                  <div className="leading-5">
                    <div>Công ty cổ phần Y Khoa HANO</div>
                  </div>
                </div>
                <div className="flex flex-row pb-2">
                  <div>
                  ...
                  <div className="leading-5">
                    <div>Số 29 Hàn Thuyên, Hai Bà Trưng, Hà Nội</div>
                  </div>
                </div>
                <div className="flex flex-row pb-2">
                  <div>
                    <svg
                      ...
                      height="25"
                      fill="currentColor"
                      className="pr-2 bi bi-telephone"
                      viewBox="0 0 16 16"
                    >
            ...
            <div className="w-80 h-60 ml-5">
              <div className="font-semibold mb-3">LIÊN KẾT VỚI CHÚNG TÔI</div>
                ...
                <div className="absolute top-0 z-20">
                  <div className="flex flex-row p-2">
                    ...
                    <div>
                      ...
                      <div className="text-xs">48.197 người theo dõi</div>
                    </div>
                  </div>
                </div>
          ...
          <div className="flex flex-row pt-7 mt-10 border-t-2 justify-between">
            <div>Coppyright ©2023 Benhvienhanoi. All Right Reserved.</div>
