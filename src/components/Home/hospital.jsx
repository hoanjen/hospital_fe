...
export default function Hospital() {
   ...
   return (
      <div onPointerEnter={() => { setHover(true) }} onPointerLeave={() => { setHover(false) }}>
         {hover ? <div className="max-w-[280px] cursor-pointer border border-slate-300 rounded-xl overflow-hidden relative shadow-md">
            <div>
            ...
            <div className="border border-slate-300 z-10 absolute left-4 top-20 rounded-lg overflow-hidden">
               <img className="w-24" src="https://cdn.youmed.vn/photos/14c1b0c8-1b44-48e6-ab0d-b4b989a86b45.png?width=100&aspect_ratio=1:1" alt="" />
            </div>
