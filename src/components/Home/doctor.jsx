...
export default function Doctor() {
   ...
   return (
      <div onPointerEnter={() => { setHover(true) }}  onPointerLeave={()=>{setHover(false)}} className="flex flex-col justify-between cursor-pointer border border-slate-300 w-[287px] h-[278px] rounded-xl hover:shadow-md" >
