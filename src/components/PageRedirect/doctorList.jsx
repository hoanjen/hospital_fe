                  ...
                  <div key={index} className="m-2">
                     <div className="flex flex-col bg-white justify-between cursor-pointer border border-slate-300 w-[287px] h-[278px] rounded-xl hover:shadow-md" >
                        <div className="flex flex-col items-center mt-5">
                           ...
                           <div className="text-base text-blue-500 font-semibold my-2"><Skeleton width={147} height={24}></Skeleton></div>
                           <div className="text-sm"><Skeleton width={128}></Skeleton></div>
                           <div className="text-sm my-2"><Skeleton width={175}></Skeleton></div>
                        </div>
                        <div className="font-semibold p-1 pl-4 border-t-1 border-slate-300"><Skeleton width={100}></Skeleton></div>
                     </div>
                  </div>
               )
            })
