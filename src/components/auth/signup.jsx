...
export default function Signup(props) {
  ...
  const [againPasswordDisplay, setAgainPasswordDisplay] = useState(false)
          ...
          <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-2xl xl:p-0 dark:bg-gray-800 dark:border-gray-700">
            <div className='mt-6 relative'>
              ...
              <div
                ...
                className="absolute p-1 m-4 top-[-24px] z-10 right-0 cursor-pointer hover:text-red50 rounded-full"
              >
                <svg
              ...
              >
                ...
                <div className='relative'>
                  ...
                  <input ref={paRef}
                    ...
                    type={!againPasswordDisplay ? 'password' : 'text'}
                    name="password"
                    id="password"
                    placeholder="••••••••"
                    className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                  ...
                  {!currentPasswordDisplay ? (
                    ...
                    <div
                      onClick={() => {
                        setAgainPasswordDisplay(!currentPasswordDisplay);
                      }}
                      className="cursor-pointer absolute right-5 top-[43px]"
                    >
                      <svg
