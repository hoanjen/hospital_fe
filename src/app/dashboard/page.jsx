  ...
  return (
    <div className="">
      <div className="w-screen bg-bluehome h-[520px] relative ">
        <img
          className="float-right bg-bluehome h-[520px]"
          src="https://res.cloudinary.com/drlvs8ebw/image/upload/v1697647330/Hospital/exxw5coy7klf0danagft.jpg"
          alt=""
        />
      ...
      <div className="w-screen bg-bluehome text-white flex justify-around px-64 pb-8">
        ...
        <div className="flex">
          <div>
            <div className="font-bold text-2xl">1.256.174</div>
