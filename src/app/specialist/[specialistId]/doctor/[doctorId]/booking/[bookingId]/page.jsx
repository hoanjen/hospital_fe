        ...
        {isLoadingPage ?  
          <div className="m-5 flex">
            <div className="bg-white w-[600px] m-5 rounded-xl pb-10">
              <div className="m-5 font-bold text-xl">Hồ sơ bệnh nhân</div>
              <div className="m-5">
                <div className="flex items-center">
                  <div className="w-16 rounded-xl object-cover ">
                    <Skeleton className="" width={64} height={64}></Skeleton>
                  </div>
                  <div className="ml-5 ">
                    <Skeleton className="" width={185} height={24}></Skeleton>
                    <Skeleton className="" width={185} height={20}></Skeleton>
                  </div>
                </div>
                <div className="flex justify-between border-t-1 p-2 mt-7">
                  <Skeleton className="" width={107} height={24}></Skeleton>
                  <Skeleton className="" width={240} height={24}></Skeleton>
                </div>
                <div className="flex justify-between border-t-1 p-2">
                  <Skeleton className="" width={62} height={24}></Skeleton>
                  <Skeleton className="" width={40} height={24}></Skeleton>
                </div>
                <div className="flex justify-between border-t-1 p-2">
                  <Skeleton className="" width={75} height={24}></Skeleton>
                  <Skeleton className="" width={90} height={24}></Skeleton>
                </div>
                <div className="flex justify-between border-t-1 p-2">
                  <Skeleton className="" width={107} height={24}></Skeleton>
                  <Skeleton className="" width={107} height={24}></Skeleton>
                ...
                <div className="flex justify-between border-t-1 p-2">
                  ...
                  <Skeleton className="" width={154} height={24}></Skeleton>
                </div>
              </div>
            ...
            <div className="bg-white w-[400px] h m-5 ml-0 rounded-xl">
              <div className="m-5">
                <div className="font-medium rounded-xl">Thông tin đặt khám</div>
                <div className="flex items-center border-y-1 p-2">
                  <div className="w-16 ">
                    <Skeleton className="" width={64} height={64}></Skeleton>
                  </div>
                  <Skeleton className="ml-5" width={240} height={24}></Skeleton>
                </div>
                <div className="mt-3 flex justify-between">
                  <Skeleton className="" width={85} height={24}></Skeleton>
                  <Skeleton className="" width={85} height={24}></Skeleton>
                </div>
                <div className="mt-3 flex justify-between">
                  <Skeleton className="" width={85} height={24}></Skeleton>
                  <div>
                    <Skeleton className="" width={96} height={24}></Skeleton>
                  </div>
                </div>
                <div className="mt-3 flex justify-between">
                  <Skeleton className="" width={80} height={24}></Skeleton>
                  <Skeleton className="" width={131} height={24}></Skeleton>
                </div>
                <div className="mt-3 flex justify-between">
                  <Skeleton className="" width={100} height={24}></Skeleton>
                  <Skeleton className="" width={66} height={24}></Skeleton>
                </div>
                <div className="mt-3 flex justify-between">
                  <Skeleton className="" width={94} height={24}></Skeleton>
                  <Skeleton className="" width={230} height={24}></Skeleton>
                </div>

                <Skeleton className="mt-56" width={360} height={48}></Skeleton>
              </div>
            </div>
          </div>
              ...
              <div className="m-5 p-2">
                ...
                <div className="w-[540px] h-28">
                  <textarea
                    ...
                    placeholder="Triệu chứng, thuốc đang dùng, v.v"
                    className="text-sm w-full h-28 max-h-36 min-w-[500px] border-2 border-slate rounded-lg"
                    type="text"
                  />
                </div>
              </div>
            ...
            <div className="bg-white w-[400px] h m-5 ml-0 rounded-xl">
              <div className="m-5">
                ...
                <div className="flex items-center border-y-1 p-2">
                  ...
                  <div className="ml-5">Bác sĩ {doctor.name}</div>
                </div>
                <div className="mt-3 flex justify-between">
                  <div>Ngày khám</div>
                ...
                <div
                  onClick={() => {
                    booking(pathname.bookingId);
                  }}
                  className={
                    isLoading
                      ? 'bg-bluehome text-base text-white flex items-center justify-center p-3 mt-56 rounded-md cursor-pointer relative opacity-70'
                      : 'bg-bluehome text-base text-white flex items-center justify-center p-3 mt-56 rounded-md cursor-pointer relative'
                  }
                >
                  Đặt lịch
